...
export function getWinner(p1, p2, p3, p4, hand1, hand2, hand3, hand4) {
    const rank1 = getRank(hand1.type), rank2 = getRank(hand2.type), rank3 = getRank(hand3.type), rank4 = getRank(hand4.type)
    ...
    if (rank1 > rank2 && rank1 > rank3 && rank1 > rank4) return p1
    else if (rank2 > rank1 && rank2 > rank3 && rank2 > rank4) return p2
    else if (rank3 > rank2 && rank3 > rank1 && rank3 > rank4) return p3
    else if (rank4 > rank2 && rank4 > rank1 && rank4 > rank3) return p4
        ...
        if (rank1 !== 'Royal Flush') {
            ...
            if (hand1.primary > hand3.primary) return p1
            else if (hand1.primary < hand3.primary) return p3

            else if (hand1.primary === hand3.primary) {

                if (hand1.secondary) { // checks if secondary criteria exists

                    if (hand1.secondary > hand3.secondary) return p1
                    else if (hand1.secondary < hand3.secondary) return p3

                    else if (hand1.secondary === hand3.secondary) {

                        if (hand1.tertiary) { // checks if tertiary criteria exists

                            if (hand1.tertiary > hand3.tertiary) return p1
                            else if (hand1.tertiary < hand3.tertiary) return p3

                            else if (hand1.tertiary === hand3.tertiary) return 'Tie'
                        }
        ...
        if (rank1 !== 'Royal Flush') {
            ...
            if (hand1.primary > hand4.primary) return p1
            else if (hand1.primary < hand4.primary) return p4

            else if (hand1.primary === hand4.primary) {

                if (hand1.secondary) { // checks if secondary criteria exists

                    if (hand1.secondary > hand4.secondary) return p1
                    else if (hand1.secondary < hand4.secondary) return p4

                    else if (hand1.secondary === hand4.secondary) {

                        if (hand1.tertiary) { // checks if tertiary criteria exists

                            if (hand1.tertiary > hand4.tertiary) return p1
                            else if (hand1.tertiary < hand4.tertiary) return p4

                            else if (hand1.tertiary === hand4.tertiary) return 'Tie'
                        }
        ...
        if (rank2 !== 'Royal Flush') {

            if (hand2.primary > hand3.primary) return p2
            else if (hand2.primary < hand3.primary) return p3

            else if (hand2.primary === hand3.primary) {

                if (hand2.secondary) { // checks if secondary criteria exists

                    if (hand2.secondary > hand3.secondary) return p2
                    else if (hand2.secondary < hand3.secondary) return p3

                    else if (hand2.secondary === hand3.secondary) {

                        if (hand2.tertiary) { // checks if tertiary criteria exists

                            if (hand2.tertiary > hand3.tertiary) return p2
                            else if (hand2.tertiary < hand3.tertiary) return p3

                            else if (hand2.tertiary === hand3.tertiary) return 'Tie'
                        }
        ...
        if (rank2 !== 'Royal Flush') {
            ...
            if (hand2.primary > hand4.primary) return p2
            else if (hand2.primary < hand4.primary) return p4

            else if (hand2.primary === hand4.primary) {

                if (hand2.secondary) { // checks if secondary criteria exists

                    if (hand2.secondary > hand4.secondary) return p2
                    else if (hand2.secondary < hand4.secondary) return p4

                    else if (hand2.secondary === hand4.secondary) {

                        if (hand2.tertiary) { // checks if tertiary criteria exists

                            if (hand2.tertiary > hand4.tertiary) return p2
                            else if (hand2.tertiary < hand4.tertiary) return p4

                            else if (hand2.tertiary === hand4.tertiary) return 'Tie'
                        }
        ...
        if (rank3 !== 'Royal Flush') {

            if (hand3.primary > hand4.primary) return p3
            else if (hand3.primary < hand4.primary) return p4

            else if (hand3.primary === hand4.primary) {

                if (hand3.secondary) { // checks if secondary criteria exists

                    if (hand3.secondary > hand4.secondary) return p3
                    else if (hand3.secondary < hand4.secondary) return p4

                    else if (hand3.secondary === hand4.secondary) {

                        if (hand3.tertiary) { // checks if tertiary criteria exists

                            if (hand3.tertiary > hand4.tertiary) return p3
                            else if (hand3.tertiary < hand4.tertiary) return p4

                            else if (hand3.tertiary === hand4.tertiary) return 'Tie'
                        }
